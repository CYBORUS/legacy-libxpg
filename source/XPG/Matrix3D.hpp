...
namespace XPG
{
    ...
    {
        Matrix4x4<T> first(mData);

        mData[0] = (first[0] * inMatrix[0]) + (first[4] * inMatrix[1])
            + (first[8] * inMatrix[2]) + (first[12] * inMatrix[3]);
        mData[4] = (first[0] * inMatrix[4]) + (first[4] * inMatrix[5])
            + (first[8] * inMatrix[6]) + (first[12] * inMatrix[7]);
        mData[8] = (first[0] * inMatrix[8]) + (first[4] * inMatrix[9])
            + (first[8] * inMatrix[10]) + (first[12] * inMatrix[11]);
        mData[12] = (first[0] * inMatrix[12]) + (first[4] * inMatrix[13])
            + (first[8] * inMatrix[14]) + (first[12] * inMatrix[15]);
        mData[1] = (first[1] * inMatrix[0]) + (first[5] * inMatrix[1])
            + (first[9] * inMatrix[2]) + (first[13] * inMatrix[3]);
        mData[5] = (first[1] * inMatrix[4]) + (first[5] * inMatrix[5])
            + (first[9] * inMatrix[6]) + (first[13] * inMatrix[7]);
        mData[9] = (first[1] * inMatrix[8]) + (first[5] * inMatrix[9])
            + (first[9] * inMatrix[10]) + (first[13] * inMatrix[11]);
        mData[13] = (first[1] * inMatrix[12]) + (first[5] * inMatrix[13])
            + (first[9] * inMatrix[14]) + (first[13] * inMatrix[15]);
        mData[2] = (first[2] * inMatrix[0]) + (first[6] * inMatrix[1])
            + (first[10] * inMatrix[2]) + (first[14] * inMatrix[3]);
        mData[6] = (first[2] * inMatrix[4]) + (first[6] * inMatrix[5])
            + (first[10] * inMatrix[6]) + (first[14] * inMatrix[7]);
        mData[10] = (first[2] * inMatrix[8]) + (first[6] * inMatrix[9])
            + (first[10] * inMatrix[10]) + (first[14] * inMatrix[11]);
        mData[14] = (first[2] * inMatrix[12]) + (first[6] * inMatrix[13])
            + (first[10] * inMatrix[14]) + (first[14] * inMatrix[15]);
        mData[3] = (first[3] * inMatrix[0]) + (first[7] * inMatrix[1])
            + (first[11] * inMatrix[2]) + (first[15] * inMatrix[3]);
        mData[7] = (first[3] * inMatrix[4]) + (first[7] * inMatrix[5])
            + (first[11] * inMatrix[6]) + (first[15] * inMatrix[7]);
        mData[11] = (first[3] * inMatrix[8]) + (first[7] * inMatrix[9])
            + (first[11] * inMatrix[10]) + (first[15] * inMatrix[11]);
        mData[15] = (first[3] * inMatrix[12]) + (first[7] * inMatrix[13])
            + (first[11] * inMatrix[14]) + (first[15] * inMatrix[15]);
    }
