...
namespace XPG
{
    ...
    void KeyboardEventListener::onKeyDown(Key::Code inKey) {}
    void KeyboardEventListener::onKeyRepeat(Key::Code inKey) {}
    void KeyboardEventListener::onKeyUp(Key::Code inKey) {}
